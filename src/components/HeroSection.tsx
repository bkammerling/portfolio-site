...
export default function HeroSection() {
  ...
  return (
    <section className={`hero min-h-[calc(90vh-4rem)] flex items-center justify-center relative overflow-hidden ${currentTheme.typography.fontFamily}`}>
      ...
      <div className={`content max-w-4xl mx-auto px-4 sm:px-6 lg:px-8  z-10 ${currentTheme.background.type === 'video' ? 'absolute bottom-[25%] mix-blend-plus-lighter opacity-80' : 'relative'}`}>
